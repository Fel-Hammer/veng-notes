...
1. **Cleave Sequence**: Reaver's Glaive > Soul Cleave > Fracture
   - Produces high AoE damage
   - Applies a single stack of Reaver's Mark

2. **Fracture Sequence**: Reaver's Glaive > Fracture > Soul Cleave
   - Generates lower AoE damage
   - Applies two stacks of Reaver's Mark

<Aside type="caution" title="Fury Management">
Prioritize Immolation Aura and Sigil of Flame, even if it disrupts your RG Sequence. A typical RG Sequence timing is: Reaver's Glaive + Fracture + Soul Cleave + Fury Generators (if necessary), usually taking about 3-4 GCDs.
</Aside>
...
Buff Windows, or RG Cycles, consist of two phases with different active buff combinations:
...
No Spirit Bomb builds are not recommended for Aldrachi Reaver. They are less damage in all scenarios. This is for three reasons:
1. Spirit Bomb can consume souls quickly
...
The trade-off for dropping Spirit Bomb is a simplified rotation. =It's possible to play this way, but it comes at a significant cost.
